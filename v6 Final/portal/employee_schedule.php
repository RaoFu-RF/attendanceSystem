									...
									<tr>
										...
										for($j=0;$j<=20;$j++) {
											...
											if($chk->num_rows > 0) {
												...
												<?php } elseif($row['id'] != $id) {?>
													<td><?php echo $get['shift'];?><?php echo $offType;?></td>
													<?php } ?>
												
												<?php 
												} else { 
													?>
													<td><?php echo $offType;?></td>
													<?php
													}
												}
												?>
						...
						<form id="user-frm">
							<div class ="modal-body">
								...
								<div class="form-group">
									<label>Shift:</label>
									<input type="text" name="shift" maxlength="15" disabled class="form-control" />
								</div>
								<div class="form-group">
  									<label for="notes_textbox">Notes</label>
 									 <textarea class="form-control rounded-0" name="notes" id="notes" rows="3" maxlength="100" disabled></textarea>
								</div>
							</div>
						</form>
					</div>
